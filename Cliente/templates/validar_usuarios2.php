...
?>
<!--HACER VALIDACION PARA CUANDO NO TENGO NADA EN EL ARRAY -->
...
<br>
<form action="../../Servidor/registrar_usuarios_validados.php" method="POST" class="container form-control">
            ...
            $resultado=mysqli_query($mysqli,$consulta);
                    ...
                    <button type="submit" class="fa-sharp fa-solid fa-x btn btn-danger" id="registro"  onclick="envio();"></button>
                   ...
                   <form action="../../Servidor/eliminar_usuario.php" method="POST">
                    ...
                    <button  class="fa-sharp fa-solid fa-x btn btn-danger"></button>
                    </form>
                -->
                    </div>
                    </div>
      ...
      <script>
        //'<script>window.location.href='../Cliente/templates/gestion_usuarios.php'; 
        function eliminador(){
            alert("SE EJECUTO EL ELIMINADOR");
            window.location.href='../../Servidor/eliminar_usuario.php';
