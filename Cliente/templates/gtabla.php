     ...
     <div class="modal-body">
       <form  action="../../Servidor/registrar_usuario.php" method="POST" enctype="multipart/form-data" >
        ...
        <!--
         ...
         <div class="mb-1">
           <label for="nombre" class="emerge col-form-label">Primer nombre:</label> 
           <input type="text" class="emerge form-control-sm" id="nombre" name="nombre" required> 
         </div>
         <div class="mb-1">
           <label for="segundonombre" class="emerge col-form-label">Segundo Nombre:</label> 
           <input type="text" class="emerge form-control-sm" id="segundonombre" name="segundonombre" required> 
         </div>
         <div class="mb-1">
           <label for="primerapellido" class="emerge col-form-label">Primer apellido:</label> 
           <input type="text" class="emerge form-control-sm" id="primerapellido" name="primerapellido" required> 
         </div>
         <div class="mb-1">
           <label for="segundoapellido" class="emerge col-form-label">Segundo apellido:</label> 
           <input type="text" class="emerge form-control-sm" id="segundoapellido" name="segundoapellido" required> 
         </div>
         <div class="mb-1">
           <label for="cargo" class="emerge col-form-label">Cargo o N° de contrato:</label> 
...
<br>
                ...
                <div class="imagen">
    <img  src="../imgs/logocompleto.png"  alt="" style="width: 70px; text-align: center;height: 30px">
    </div>
